...
export const nodes: NodeRecord[] = [
  {
    ...
    sipStatus: "Active",
    ipPool: [
      { address: "10.10.0.11", role: "MAIN", status: "Active", whitelistUse: "Internal only", interfaceName: "eth0" },
      { address: "10.10.0.12", role: "SIP", status: "Active", whitelistUse: "Customer + Vendor", interfaceName: "eth0" },
      { address: "10.10.0.13", role: "MEDIA", status: "Active", whitelistUse: "Internal only", interfaceName: "eth1" },
      { address: "10.10.0.14", role: "MEDIA", status: "Active", whitelistUse: "Internal only", interfaceName: "eth1" },
      { address: "10.10.0.15", role: "MEDIA", status: "Reserved", whitelistUse: "Internal only", interfaceName: "eth1" },
    ],
    mediaIps: [
  ...
  },
  {
    ...
    sipStatus: "Standby",
    ipPool: [
      { address: "10.20.0.21", role: "MAIN", status: "Active", whitelistUse: "Internal only", interfaceName: "ens3" },
      { address: "10.20.0.22", role: "SIP", status: "Active", whitelistUse: "Customer + Vendor", interfaceName: "ens3" },
      { address: "10.20.0.23", role: "MEDIA", status: "Active", whitelistUse: "Internal only", interfaceName: "ens4" },
      { address: "10.20.0.24", role: "MEDIA", status: "Reserved", whitelistUse: "Internal only", interfaceName: "ens4" },
    ],
    mediaIps: [
  ...
  },
  {
    ...
    sipStatus: "Disabled",
    ipPool: [
      { address: "10.30.0.31", role: "MAIN", status: "Active", whitelistUse: "Internal only", interfaceName: "eth0" },
      { address: "10.30.0.32", role: "SIP", status: "Reserved", whitelistUse: "Customer + Vendor", interfaceName: "eth0" },
    ],
    mediaIps: [],
  },
];
...
export const usageByNode: UsageByNodeItem[] = nodes.map((node) => ({
  name: node.name,
  region: node.region,
...
export const usageByPool: UsageByPoolItem[] = mediaPools.map((pool) => {
...
export const usageByMediaIp: UsageByMediaIpItem[] = mediaPools.flatMap((pool) =>
...
export const mockControlPanelData: ControlPanelData = {
  navigation,
  dashboardMetrics,
  customers,
  vendors,
